 ...
 */
 ...
 //    * getViewportHeight line:1155, 1168 * setup line: 190
 //     slide button append line:646 => 771
 //    	var updateDirectionControls button visible set line: 854
;(function(jQuery){
	...
	jQuery.fn.bxSlider = function(options){
		...
		var appendControls = function(){
			slider.controls.next = jQuery('<a class="bx-next" href="#" role="navigation">' + slider.settings.nextText + '</a>');
			slider.controls.prev = jQuery('<a class="bx-prev" href="#" role="navigation">' + slider.settings.prevText + '</a>');
